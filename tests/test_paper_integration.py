...
now = datetime.now()
opened = pf.open_position("SBIN", "Banking", "LONG", 625.50, now)
...
r1 = pf2.open_position("SBIN", "Banking", "LONG", 625.0, now)
r2 = pf2.open_position("RELIANCE", "Energy", "SHORT", 2500.0, now)
r3 = pf2.open_position("TCS", "IT", "LONG", 3800.0, now)
r4 = pf2.open_position("INFY", "IT", "LONG", 1500.0, now)  # Should fail (max 3)
